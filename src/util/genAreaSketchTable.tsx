...
export const ReplicateAreaSketchTableStyled = styled(ReportTableStyled)`
  & {
    width: 100%;
    overflow-x: scroll;
    font-size: 12px;
...
/**
 * Creates "Show by Zone" report, with area, percentages, replicates
 ...
 * @param t TFunction
 */
export const genReplicateAreaSketchTable = (
  data: ReportResult,
