            ...
            <ReportError>
              ...
              >
                <Trans i18nKey="Shoretypes 1">
                  <p>
                    Alongshore habitats, such as sandy beach and rocky
                    intertidal, provide an important connection between land and
                    sea for marine species and humans alike. This report
                    summarizes the overlap of the selected MPA(s) with sandy
                    beach and rocky intertidal habitat. Data are included for
                    both landward and seaward shoreline, so a single segment of
                    shoreline may be counted towards more than one type of
                    habitat.
                  </p>
                  <p>
                    The minimum length of habitat within an MPA necessary to
                    encompass 90% of local biodiversity and count as a
                    replicate, as determined from biological surveys, is 1.1
                    linear miles for beach habitats and 0.55 linear miles for
                ...
                <Collapse
                  ...
                  key={props.printing + "Shoretypes Planning Region"}
                ...
                <Collapse
                  ...
                  key={props.printing + "Shoretypes Bioregion"}
                  collapsed={!props.printing}
                >
                  {metricGroup.classes.map((curClass) => (
                    <GeographyTable
                ...
                {isCollection && (
                  <Collapse
                    title={t("Show by MPA")}
                    key={props.printing + "Shoretypes MPA"}
                    collapsed={!props.printing}
                  >
                ...
                <Collapse
                  title={t("Learn More")}
                  key={props.printing + "Shoretypes Learn More"}
                  collapsed={!props.printing}
                >
                  <Trans i18nKey="Shoretypes - learn more">
                    ...
                    <p>
                      ...
                      shoretype within the selected MPA(s). This value is
                      divided by the total length of each shoretype to obtain
                      the % contained within the selected MPA(s). If the
                      selected area includes multiple areas that overlap, the
                      overlap is only counted once. Selected MPA(s) were
                      buffered by 250 meters to ensure overlap with shoreline
                      habitats data layer.
                    </p>
                  </Trans>
